...
public abstract class CollidableEntity extends Entity {
	...
	protected CollidableEntity(GameWorld world, int categoryMask, int collisionMask) {
	...
	/**
	 * @param other
	 * Return a Collision object representing the collision with other.
	 * If there is no collision, the mtv is null and the Collision is not valid
