...
public class FinalWorld extends GameWorld {
	...
	public FinalWorld(Vec2f dimensions) {
		...
		entities.put("wall1", new Wall(this, new AAB(new Vec2f(160.0f, 16.0f),
				Color.BLACK, Color.BLACK, new Vec2f(320.0f, 32.0f)), "wall1",
				wallProperties));
		entities.put("wall2", new Wall(this, new AAB(new Vec2f(544.0f, 16.0f),
				Color.BLACK, Color.BLACK, new Vec2f(320.0f, 32.0f)), "wall2",
				wallProperties));
		entities.put("wall3", new Wall(this, new AAB(new Vec2f(16.0f, 240.0f),
				Color.BLACK, Color.BLACK, new Vec2f(32.0f, 480.0f)), "wall3",
				wallProperties));
		entities.put("wall4", new Wall(this, new AAB(new Vec2f(624.0f, 240.0f),
				Color.BLACK, Color.BLACK, new Vec2f(32.0f, 480.0f)), "wall4",
				wallProperties));
		entities.put("wall5", new Wall(this, new AAB(new Vec2f(320.0f, 464.0f),
				Color.BLACK, Color.BLACK, new Vec2f(640.0f, 32.0f)), "wall5",
				wallProperties));
		entities.put("wall6", new Wall(this, new AAB(new Vec2f(192.0f, 270.0f),
				Color.BLACK, Color.BLACK, new Vec2f(384.0f, 32.0f)), "wall6",
				wallProperties));
		entities.put("wall7", new Wall(this, new AAB(new Vec2f(192.0f, 302.0f),
				Color.BLACK, Color.BLACK, new Vec2f(384.0f, 32.0f)), "wall7",
				wallProperties));
		entities.put("wall8", new Wall(this, new AAB(new Vec2f(544.0f, 270.0f),
				Color.BLACK, Color.BLACK, new Vec2f(192.0f, 32.0f)), "wall8",
				wallProperties));
		entities.put("wall9", new Wall(this, new AAB(new Vec2f(544.0f, 302.0f),
				Color.BLACK, Color.BLACK, new Vec2f(192.0f, 32.0f)), "wall9",
				wallProperties));
		entities.put("wall10", new Wall(this, new AAB(new Vec2f(240.0f, 48.0f),
				Color.BLACK, Color.BLACK, new Vec2f(32.0f, 96.0f)), "wall10",
				wallProperties));
		entities.put("wall11", new Wall(this, new AAB(new Vec2f(272.0f, 48.0f),
				Color.BLACK, Color.BLACK, new Vec2f(32.0f, 96.0f)), "wall11",
				wallProperties));
		entities.put("wall12", new Wall(this, new AAB(
				new Vec2f(240.0f, 208.0f), Color.BLACK, Color.BLACK, new Vec2f(
						32.0f, 96.0f)), "wall12", wallProperties));
		entities.put("wall13", new Wall(this, new AAB(
