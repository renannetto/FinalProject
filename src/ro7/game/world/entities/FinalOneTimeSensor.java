...
import ro7.engine.world.entities.OneTimeSensor;
import ro7.game.world.items.Item;

public class FinalOneTimeSensor extends OneTimeSensor implements FinalEntity {

	public FinalOneTimeSensor(GameWorld world, CollidingShape shape,
